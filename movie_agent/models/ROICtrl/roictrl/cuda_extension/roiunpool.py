...
roiunpool_cpp = os.path.join(current_directory, "models/ROICtrl/roictrl/cuda_extension/roiunpool.cpp")
roiunpool_cu = os.path.join(current_directory, "models/ROICtrl/roictrl/cuda_extension/roiunpool.cu")

roiunpool = load(name="roiunpool", sources=[roiunpool_cpp, roiunpool_cu], verbose=True)
